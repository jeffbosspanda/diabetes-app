    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <ul className="sickday-list">
          <li><b>不可自行停打胰島素</b>：即使吃不下，長效（基礎）胰島素仍要照打；生病時壓力荷爾蒙上升、胰島素阻抗增加，身體反而更需要胰島素。</li>
          <li><b>勤量血糖</b>：每 2–4 小時測一次（夜間也要）；血糖高時依校正劑量補打速效，與平常一樣先諮詢醫師訂好的 sick-day 規則。</li>
          <li><b>注意酮體</b>：血糖持續 &gt; 250 mg/dL 或嘔吐時，檢查血／尿酮；有酮體 + 高血糖要提高警覺（DKA 風險），酮體高時常需額外速效胰島素 + 補水。</li>
          <li><b>補充水分</b>：少量多次喝水；吃不下時改喝含醣飲料（果汁、運動飲料）維持碳水避免低血糖。</li>
        </ul>

        <div className="sickday-med-head">💊 生病用藥對血糖的影響</div>
        <ul className="sickday-list">
          <li><b>會升血糖</b>：類固醇（口服／注射／關節注射）影響最大，血糖可飆高數天，需與醫師討論加強胰島素；部分感冒糖漿、喉糖、中藥含糖。</li>
          <li><b>相對安全</b>：普拿疼（acetaminophen）等退燒止痛藥對血糖影響小，但仍依藥師指示劑量。</li>
          <li><b>生病可能需暫停（問醫師）</b>：第二型口服藥 metformin、SGLT2 抑制劑（〜gliflozin）在發燒、嘔吐、腹瀉脫水時可能需暫停（SGLT2 有正常血糖型酮酸中毒風險）。</li>
          <li><b>抗生素／其他</b>：依醫囑服完療程；服藥後血糖異常波動請記錄並回報醫師。</li>
        </ul>

        <div className="sickday-alert">
          ⚠️ 出現以下情況請盡速就醫：持續嘔吐無法進食或喝水、血糖居高不下且有酮體、呼吸急促或喘、意識改變或嗜睡、低血糖反覆無法回升。
        </div>
      </div>
